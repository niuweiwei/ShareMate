...
public class VerifyCodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SMSSDK.getVerificationCode("86", phoneNum);// 发送验证码给号码的 phoneNum 的手机
        Log.e("phoneNum",phoneNum);
        MobSDK.init(VerifyCodeActivity.this,AppKey,AppSecret);
...
//                    verifyCodeView.getEditContent(),Toast.LENGTH_SHORT).show();
            ...
            if (code.length() == 4){
                ...
                Toast.makeText(VerifyCodeActivity.this,"请输入完整的验证码",Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(VerifyCodeActivity.this, "验证成功", Toast.LENGTH_SHORT).show();
                ...
                //如果操作失败
                if (flag){
                    Toast.makeText(VerifyCodeActivity.this,"验证码获取失败，请重新获取",Toast.LENGTH_SHORT).show();
                }else {
