 ...
 */
@WebServlet("/DongmanNoteServlet")
public class DongmanNoteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DongmanNoteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userid!=null) {
	    	...
	    	noteLike=like.getLikeNoteList(userId);
		...
		//UserBean user = (UserBean) session.getAttribute("user");
    		...
    		if(session.getAttribute("noteList")==null) {
    			noteList = noteDao.getNoteBytypeId(4);
